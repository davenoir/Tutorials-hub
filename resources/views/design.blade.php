    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-sm-12 col-12">
            <div class="row text-center" style="margin-top:5%">
                <div class="col-md-12 col-sm-12 col-12">
                    <h1 class="headingListingsPage" style="font-weight:900">Find the Best Design Courses & Tutorials</h1>
                </div>
            </div>
            <div class="row" style="margin-top:3.5%">
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="form-group has-search">
                        ...
                        <input id="searchDesign" type="text" class="form-control rounded-pill" placeholder="Search for the technology you want to learn">
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
  ...
  $(function() {
    ...
    $('#searchDesign').on('keyup',function(){
        $value=$(this).val();
        $.ajax({
        type : 'get',
        url : '{{URL::to('searchDesign')}}',
        data:{'search':$value},
